...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'asset' => Teepluss\Theme\Asset::class,
        'theme' => Teepluss\Theme\Theme::class,
        'breadcrumb' => Teepluss\Theme\Breadcrumb::class,
        'theme.create' => Teepluss\Theme\Commands\ThemeGeneratorCommand::class,
        'theme.widget' => Teepluss\Theme\Commands\WidgetGeneratorCommand::class,
        'theme.destroy' => Teepluss\Theme\Commands\ThemeDestroyCommand::class,
        'html' => Collective\Html\HtmlBuilder::class,
        'form' => Collective\Html\FormBuilder::class,
        'validation.presence' => Illuminate\Validation\DatabasePresenceVerifier::class,
        'translation.loader' => Illuminate\Translation\FileLoader::class,
        'translator' => Illuminate\Translation\Translator::class,
        'Collective\Bus\Dispatcher' => Collective\Bus\Dispatcher::class,
