 ...
 * Generated for Laravel 5.2.45 on 2017-06-24.
 *
...
namespace Collective\Html { 
    ...
    class FormFacade {
        ...
        {
            return \Collective\Html\FormBuilder::image_data($image, $contents);
        }
         ...
         * @static 
         */ 
        public static function nav_link($url, $text, $url2 = '', $extra = '')
        {
            return \Collective\Html\FormBuilder::nav_link($url, $text, $url2, $extra);
        }
        ...
        {
            return \Collective\Html\FormBuilder::tab_link($url, $text, $active);
        }
        ...
        {
            return \Collective\Html\FormBuilder::menu_link($type);
        }
        ...
        {
            return \Collective\Html\FormBuilder::flatButton($label, $color);
        }
        ...
        {
            return \Collective\Html\FormBuilder::emailViewButton($link, $entityType);
        }
         ...
         * @static 
         */ 
        public static function emailPaymentButton($link = '#')
        {
            return \Collective\Html\FormBuilder::emailPaymentButton($link);
        }
        ...
        {
            return \Collective\Html\FormBuilder::breadcrumbs($status);
        }
        ...
        {
            return \Collective\Html\FormBuilder::human_filesize($bytes, $decimals);
        }
