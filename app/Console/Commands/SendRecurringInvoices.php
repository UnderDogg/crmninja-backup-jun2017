...
class SendRecurringInvoices extends Command
{
    ...
    public function fire()
    {
        ...
        $invoices = Invoice::with('loginaccount.timezone', 'invoice_items', 'relation', 'user')
        ...
        foreach ($invoices as $recurInvoice) {
            ...
            $recurInvoice->loginaccount->loadLocalizationSettings($recurInvoice->relation);
        ...
        $delayedAutoBillInvoices = Invoice::with('loginaccount.timezone', 'recurring_invoice', 'invoice_items', 'relation', 'user')
        ...
        foreach ($delayedAutoBillInvoices as $invoice) {
            ...
            if ($invoice->getAutoBillEnabled() && $invoice->relation->autoBillLater()) {
