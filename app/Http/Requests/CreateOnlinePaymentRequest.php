...
class CreateOnlinePaymentRequest extends Request
{
    ...
    {
        $company = $this->invitation->loginaccount;
    ...
    public function sanitize()
    {
        ...
        $invitation = Invitation::with('invoice.invoice_items', 'invoice.relation.currency', 'invoice.relation.loginaccount.currency', 'invoice.relation.loginaccount.account_gateways.gateway')
