...
class ActivityListener
{
    ...
    /**
     * @param RelationWasDeleted $event
     */
    ...
    /**
     * @param RelationWasArchived $event
     */
    ...
    /**
     * @param RelationWasRestored $event
     */
    ...
    public function updatedInvoice(InvoiceWasUpdated $event)
    {
        ...
        $backupInvoice = Invoice::with('invoice_items', 'relation.loginaccount', 'relation.contacts')->find($event->invoice->id);
    ...
    public function updatedQuote(QuoteWasUpdated $event)
    {
        ...
        $backupQuote = Invoice::with('invoice_items', 'relation.loginaccount', 'relation.contacts')->find($event->quote->id);
