...
class AccountGateway extends EntityModel
{
     ...
     * @return bool|mixed
     */
    public function getPlaidRelationId()
    {
        if (!$this->isGateway(GATEWAY_STRIPE)) {
            return false;
        }

        return $this->getConfigField('plaidRelationId');
    }
    ...
    {
        return !empty($this->getPlaidRelationId()) && $this->getAchEnabled();
    }
    ...
    {
        $company = $this->loginaccount ? $this->loginaccount : Company::find($this->company_id);
