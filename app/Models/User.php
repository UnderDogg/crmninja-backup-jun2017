...
class User extends Model implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
    ...
    public function loginaccount()
    {
        ...
        //$this->loginaccount = Company::where('id', $this->company_id)->first();
    ...
    {
        return $this->loginaccount->isPro();
    }
    ...
    {
        return $this->loginaccount->hasFeature($feature);
    }
    ...
    {
        return $this->loginaccount->isTrial();
    }
    ...
    {
        return $this->loginaccount->isEligibleForTrial($plan);
    }
