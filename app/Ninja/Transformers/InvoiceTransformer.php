...
class InvoiceTransformer extends EntityTransformer
{
    ...
    */
    ...
    {
        $transformer = new InvoiceItemTransformer($this->loginaccount, $this->serializer);
    ...
    {
        $transformer = new InvitationTransformer($this->loginaccount, $this->serializer);
        return $this->includeCollection($invoice->invitations, $transformer, ENTITY_INVITATION);
    }

    public function includePayments(Invoice $invoice)
    {
        $transformer = new PaymentTransformer($this->loginaccount, $this->serializer, $invoice);
    ...
    {
        $transformer = new ExpenseTransformer($this->loginaccount, $this->serializer);
    ...
    {
        $transformer = new DocumentTransformer($this->loginaccount, $this->serializer);
    ...
    public function transform(Invoice $invoice)
    {
        return array_merge($this->getDefaults($invoice), [
            ...
            'relation_id' => (int) ($this->relation ? $this->relation->public_id : $invoice->relation->public_id),
