...
class InvoiceService extends BaseService
{
    ...
    public function save(array $data, Invoice $invoice = null)
    {
        if (isset($data['relation'])) {
            ...
            $relationPublicId = array_get($data, 'relation.public_id') ?: array_get($data, 'relation.id');
    ...
    {
        $datatable = new InvoiceDatatable(!$relationPublicId, $relationPublicId);
