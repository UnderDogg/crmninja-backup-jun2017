...
@section('body')
    <div class="container">
        ...
        @include('partials.warn_session', ['redirectTo' => '/relation/sessionexpired'])
        ...
        <div class="modal-header">
            ...
            @else
                <h4>{{ trans('texts.company_login') }}</h4>
            @endif
        </div>
        <div class="inner">
            <p>
            ...
            <p class="link">
                {!! link_to('/relation/recover_password', trans('texts.recover_password')) !!}
            </p>
