...
@section('content')
    ...
    {!! Former::populateField('corporation_name', $company->getDisplayName()) !!}

    @if ($company->country)
        {!! Former::populateField('country', $company->country->iso_3166_2) !!}
    @endif
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body form-padding-right">
            ...
            {!! Former::text('email') !!}
            {!! Former::text('corporation_name')->help('wepay_corporation_name_help')->maxlength(255) !!}
