...
@section('content')
    ...
    {!! Former::populateField('enable_relation_portal', intval($company->enable_relation_portal)) !!}
    {!! Former::populateField('enable_relation_portal_dashboard', intval($company->enable_relation_portal_dashboard)) !!}
    ...
    {!! Former::populateField('enable_buy_now_buttons', intval($company->enable_buy_now_buttons)) !!}

    @if (!Utils::isNinja() && !Auth::user()->loginaccount->hasFeature(FEATURE_WHITE_LABEL))
    ...
    @include('companies.nav', ['selected' => COMPANY_CUSTOMER_PORTAL])
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        {!! Former::checkbox('enable_relation_portal_dashboard')
                            ->text(trans('texts.enable'))
                            ->help(trans('texts.enable_relation_portal_dashboard_help')) !!}
                    </div>
                </div>
            </div>
            ...
            @if (Utils::hasFeature(FEATURE_CUSTOMER_PORTAL_CSS))
                <div class="panel panel-default">
                    <div class="panel-heading">
