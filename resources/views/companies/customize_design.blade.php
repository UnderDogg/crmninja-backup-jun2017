...
@section('content')
  ...
  <script>
    ...
    function getPDFString(cb, force) {
      ...
      invoice.loginaccount.hide_quantity = {!! Auth::user()->loginaccount->hide_quantity ? 'true' : 'false' !!};
      invoice.loginaccount.hide_paid_to_date = {!! Auth::user()->loginaccount->hide_paid_to_date ? 'true' : 'false' !!};
      NINJA.primaryColor = '{!! Auth::user()->loginaccount->primary_color !!}';
      NINJA.secondaryColor = '{!! Auth::user()->loginaccount->secondary_color !!}';
      NINJA.fontSize = {!! Auth::user()->loginaccount->font_size !!};
