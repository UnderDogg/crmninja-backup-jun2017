...
@section('content')
    ...
    @include('companies.nav', ['selected' => COMPANY_COMPANY_DETAILS])
                    ...
                    @if ($company->hasLogo())
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-sm-8">
                                <a href="{{ $company->getLogoUrl(true) }}" target="_blank">
                                    {!! HTML::image($company->getLogoUrl(true), 'Logo', ['style' => 'max-width:300px']) !!}
                                </a> &nbsp;
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div id="signatureEditor" class="form-control" style="min-height:160px"
