        ...
        <div class="panel-body form-padding-right">
            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist" style="border: none">
                    ...
                    <li role="presentation">
                        <a href="#corporationFields" aria-controls="corporationFields" role="tab" data-toggle="tab">{{ trans('texts.corporation_fields') }}</a>
                    </li>
                    <li role="presentation">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="corporationFields">
                    <div class="panel-body">
                        ...
                        {!! Former::text('custom_value2')
                                ->label(trans('texts.field_value'))
                                ->help(trans('texts.custom_company_fields_helps')) !!}
