...
@section('content')
    ...
    {{ Former::populateField('military_time', intval($company->military_time)) }}
    {{ Former::populateField('show_currency_code', intval($company->show_currency_code)) }}

    @include('companies.nav', ['selected' => COMPANY_LOCALIZATION])
