...
@section('content')
    ...
    {!! Former::populateField('token_billing_type_id', $company->token_billing_type_id) !!}
    {!! Former::populateField('auto_bill_on_due_date', $company->auto_bill_on_due_date) !!}
  ...
  @include('partials.bulk_form', ['entityType' => ENTITY_COMPANY_GATEWAY])
