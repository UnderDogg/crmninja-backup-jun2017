...
@section('content') 
  ...
  @include('companies.nav', ['selected' => COMPANY_PRODUCTS])

  {!! Former::open()->addClass('warn-on-exit') !!}
  {{ Former::populateField('fill_products', intval($company->fill_products)) }}
  {{ Former::populateField('update_products', intval($company->update_products)) }}
