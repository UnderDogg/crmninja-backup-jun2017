...
<head>
    ...
    <!--[if !mso]><!-- -->
    <link href="{{ isset($company) ? $company->getFontsUrl('http') : '' }}" rel="stylesheet" type="text/css"/>
    <!--<![endif]-->
</head>
<body style="color: #000000;{!! isset($company) ? $company->getBodyFontCss() : '' !!}font-size: 12px; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; background: #F4F5F5; margin: 0; padding: 0;"
...
<div id="body_style" style="{!! isset($company) ? $company->getBodyFontCss() : '' !!};color: #2E2B2B; font-size: 16px;
