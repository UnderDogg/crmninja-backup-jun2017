...
@section('payment_details')
    ...
    @if ($relation)
        ...
        @if (!$relation->country_id && $relation->loginaccount->country_id)
            {{ Former::populateField('country_id', $relation->loginaccount->country_id) }}
        @endif
        @if (!$relation->currency_id && $relation->loginaccount->currency_id)
            {{ Former::populateField('currency_id', $relation->loginaccount->currency_id) }}
            {{ Former::populateField('currency', $relation->loginaccount->currency->code) }}
        @endif
    @endif
