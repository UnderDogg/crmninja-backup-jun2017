...
@if (!empty($braintreeRelationToken))
    ...
    <script type="text/javascript" >
        $(function() {
            var paypalLink = $('#add-paypal'),
                    ...
                    checkout;
            braintree.setup("{{ $braintreeRelationToken }}", "custom", {
                ...
                paypal: {
                    ...
                    headless: true,
                    locale: "{{$relation->language?$relation->language->locale:$relation->loginaccount->language->locale}}"
                },
                dataCollector: {
                    paypal: true
                },
            ...
            $('#add-ach').click(function(e) {
                ...
                WePay.bankrekening.create({
                    ...
                    if(dataObj.bank_company_id) {
                        window.location.href = $('#add-ach').attr('href') + '/' + dataObj.bank_company_id + "?details=" + encodeURIComponent(data);
...
<center>
    ...
    @if (false && $company->getGatewayByType(GATEWAY_TYPE_PAYPAL) && $company->getGatewayByType(GATEWAY_TYPE_TOKEN))
        {!! Button::success(strtoupper(trans('texts.add_paypal_company')))
    ...
    <div class="modal-dialog" style="min-width:150px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>{{ trans('texts.bank_company_verification_help') }}</p>
