        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    @if ($vendor->loginaccount->custom_vendor_label1 && $vendor->custom_value1)
                        {{ $vendor->loginaccount->custom_vendor_label1 . ': ' . $vendor->custom_value1 }}<br/>
                    @endif
                    @if ($vendor->loginaccount->custom_vendor_label2 && $vendor->custom_value2)
                        {{ $vendor->loginaccount->custom_vendor_label2 . ': ' . $vendor->custom_value2 }}<br/>
                    @endif
